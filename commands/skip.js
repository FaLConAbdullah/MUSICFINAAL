...
module.exports = {
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (skipTo !== null && (isNaN(skipTo) || skipTo < 1 || skipTo > player.queue.length)) return client.sendTime(interaction, "❌ | **الرقم غير موجود!**");
            player.stop(skipTo);
            client.sendTime(interaction, "**تم تخطي الاغنية الحالية!**");
        },
    },
};
